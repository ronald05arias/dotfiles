...
plugins=(aws boot2docker bundler brew brew-cask cake coffee docker fasd gem git git-extras gitfast golang heroku hero npm postgres rails rake-fast rake rbenv redis-cli sbt scala vundle)
