...
plugins=(aws bundler brew cake coffee fasd gem git git-extras gitfast golang heroku npm postgres pow rails rake-fast rake rbenv redis-cli sbt scala vundle)
