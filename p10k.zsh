# Generated by Powerlevel10k configuration wizard on 2020-06-14 at 08:39 BST.
...
# flat tails, 2 lines, disconnected, left frame, compact, concise, transient_prompt,
...
() {
  ...
  # Show the currently selected Ruby engine (e.g. ruby, jruby, rbx, etc)
  typeset -g POWERLEVEL9K_CHRUBY_SHOW_ENGINE=false
  # Shows the currently selected engine's version (e.g. 2.5.1)
  typeset -g POWERLEVEL9K_CHRUBY_SHOW_VERSION=true
  # If set to false, hide ruby version if it's the same as global:
  # $(rbenv version-name) == $(rbenv global).
  typeset -g POWERLEVEL9K_CHRUBY_PROMPT_ALWAYS_SHOW=false
  # If set to false, hide ruby version if it's equal to "system".
  # typeset -g POWERLEVEL9K_CHRUBY_SHOW_SYSTEM=true
  # Custom icon.
  # typeset -g POWERLEVEL9K_CHRUBY_VISUAL_IDENTIFIER_EXPANSION='⭐'
